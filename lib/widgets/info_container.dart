            ...
            children: [
              Row(
                children: const [
                  ...
                  SizedBox(width: 30,),
                  Flexible(child: Text("You own the solution, with 1 year free maintanance")),
                ],
              ),
              const SizedBox(height: 30),
              Row(
                children: const [
                  CircleAvatar(child: Icon(Icons.settings_input_composite_rounded)),
                  SizedBox(width: 30,),
                  Flexible(child: Text("Furthere maintenance can be added, for a fixed price over 2 years a time")),
                ],
              ),
              const SizedBox(height: 30),
              Row(
                children: const [
                  ...
                  SizedBox(width: 30,),
                  Flexible(child: Text("You can always upgrade from one plan to another, small changes will be covered inside the maintanance plan and has no extra cost")),
                ],
              ),
              const SizedBox(height: 30),
              Row(
                children: const [
                  ...
                  SizedBox(width: 30,),
                  Flexible(child: Text("We provide clean architecture, which update in real time")),
                ],
              ),
              const SizedBox(height: 30),
              Row(
                children: const [
                  ...
                  SizedBox(width: 30,),
                  Flexible(child: Text("Our solutions contains hight test coverage, which makes the solution more robust")),
                ],
              ),
              const SizedBox(height: 30),
              Row(
                children: const [
                  ...
                  SizedBox(width: 30,),
                  Flexible(child: Text("With CI/CD tools the realese and integration is automated and new releases occurs fast")),
                ],
              )
            ],
          ),
